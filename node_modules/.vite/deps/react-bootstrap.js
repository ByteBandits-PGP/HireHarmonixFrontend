...
} from "./chunk-RRLZFUCG.js";
import {
  Anchor_default,
  useCallbackRef
} from "./chunk-TMPXTFW5.js";
import {
...
var FormGroup = React28.forwardRef(({
  ...
  return (0, import_jsx_runtime29.jsx)(FormContext_default.Provider, {
    value: context3,
...
var FormLabel = React29.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime30.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
  ...
  return (
    ...
    (0, import_jsx_runtime30.jsx)(Component2, {
      ref,
      className: classes,
      htmlFor,
      ...props
...
var FormRange = React30.forwardRef(({
  ...
  return (0, import_jsx_runtime31.jsx)("input", {
    ...props,
    type: "range",
    ref,
...
var FormSelect = React31.forwardRef(({
  ...
  return (0, import_jsx_runtime32.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
...
var Switch = React33.forwardRef((props, ref) => (0, import_jsx_runtime34.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React34.forwardRef(({
  ...
  return (0, import_jsx_runtime36.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames28.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime35.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var Modal = React43.forwardRef(({
  ...
  const renderBackdrop = (0, import_react19.useCallback)((backdropProps) => (0, import_jsx_runtime45.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React44.forwardRef(({
  ...
  return (0, import_jsx_runtime47.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames38.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime46.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
